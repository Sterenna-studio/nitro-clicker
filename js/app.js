  ...
  app.innerHTML = `
    ...
    <header class="topbar">
      ...
      <nav class="top-actions">
        ...
        <a href="./lemegeton.html" class="nav-btn">◇ TEST ŒIL</a>
...
// Noyaux orbitaux (nitroFactory) + clones hexagonaux (enginePlant), rendus en DOM.
// Root cause du crash RESULT_CODE_HUNG confirmée (cc6e0a6) : boucle infinie du
// MutationObserver d'upgrade-ux, sans rapport avec ce rendu — le retrait
// temporaire du DOM par orbite/clone (3fc41e7) n'était qu'un diagnostic écarté.
