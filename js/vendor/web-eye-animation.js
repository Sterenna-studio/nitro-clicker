// Vendored copy, frozen 2026-07-06 from https://cyberagentailab.github.io/Web-Eye-Animation/web-eye-animation.js
// (MIT, CyberAgentAILab). Was previously loaded live from that unversioned CDN
// URL — an upstream update broke it without any change on our side, so it's
// now embedded locally and pinned. Only change from upstream: loadGSAP() below
// points at the local vendored ./js/vendor/gsap.min.js instead of cdnjs.
(function() {
    // CSSを動的に生成して追加する関数
    function addCSS() {
    ...
    function loadGSAP(callback) {
        ...
        script.src = "./js/vendor/gsap.min.js";
